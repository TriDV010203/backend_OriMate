...
{
    [Fact]
    public async Task Test_All_CommandHandlers()
    {
        var assembly = typeof(LoginHandler).Assembly;
        var handlerTypes = assembly.GetTypes()
            .Where(t => t.IsClass && !t.IsAbstract && t.Name.EndsWith("Handler") && t.Namespace != null && t.Namespace.Contains("OrigamiPlatform.Application.Commands"))
            .ToList();
